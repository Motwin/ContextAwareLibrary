 ...
 * 
 */
public class MobileCountryCodeCollectorTest extends MockitoTestCase {
    private SpyChannel                 channel;
    private MobileCountryCodeCollector collector;
    @Mock
    ...
    protected void setUp() throws Exception {
        ...
        collector = new MobileCountryCodeCollector(channel, context, telephonyManager);
    };
    ...
    public void testSendContextOnStart() throws InterruptedException {
        ...
        assertEquals(ContextAware.MOBILE_COUNTRY_CODE_KEY, ctxElement.getType());
        assertEquals("abc", ctxElement.getData());
    }
}
